...
class HomeScreenState extends State<HomeScreen> {
  ...
  List<String> speakerinfo = [
    ...
    "As a part of our breakout sessions on the Friday and Saturday afternoon during conference, we are launching ‘TBCO TALKS’. Our conference is devoted to equipping the body of Christ to “Cover The Earth” with the spirit of the Lord in each person’s individual sphere of life. We will be hearing powerful talks from amazing speakers who are ambassadors of the kingdom in their respective fields.",
